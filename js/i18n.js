...
const I18N = {
  fr: {
    ...
    "nav.about": "À propos",
    "nav.contact": "Contact",
    "nav.theme": "Thème clair ou sombre",
    ...
    "pdf.title2": "PDF",
    "pdf.lead": "Vingt pages de références, tailles et tarifs de gros. Laissez-nous vos coordonnées, le téléchargement démarre aussitôt.",
    "pdf.cta": "Télécharger le catalogue",
    "pdf.form.title": "Accès au catalogue grossiste",
    "pdf.form.lead": "Merci de vous présenter — le nom et un moyen de vous recontacter suffisent, le téléchargement démarre aussitôt.",
    "pdf.form.prenom": "Prénom",
    "pdf.form.nom": "Nom",
    "pdf.form.company": "Entreprise (facultatif)",
    "pdf.form.phone": "Téléphone",
    "pdf.form.email": "E-mail",
    "pdf.form.submit": "Recevoir le catalogue",
    "pdf.form.ok": "Merci ! Le téléchargement démarre.",
    "pdf.form.err": "Merci de renseigner votre nom et un téléphone ou un e-mail valide.",
  ...
  en: {
    ...
    "pdf.title2": "PDF",
    "pdf.lead": "Twenty pages of references, sizes and wholesale prices. Leave your details and the download starts right away.",
    "pdf.cta": "Download the catalogue",
    "pdf.form.title": "Access the wholesale catalogue",
    "pdf.form.lead": "Please introduce yourself — a name and a way to reach you is all it takes, the download starts right away.",
    "pdf.form.prenom": "First name",
    "pdf.form.nom": "Last name",
    "pdf.form.company": "Company (optional)",
    "pdf.form.phone": "Phone",
    "pdf.form.email": "E-mail",
    "pdf.form.submit": "Get the catalogue",
    "pdf.form.ok": "Thank you! Your download is starting.",
    "pdf.form.err": "Please enter your name and a valid phone number or e-mail.",
